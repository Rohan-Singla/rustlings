...
// Helper function to validate and convert a triple of i16 to Color
fn i16_to_color(r: i16, g: i16, b: i16) -> Result<Color, IntoColorError> {
    if (0..=255).contains(&r)
        && (0..=255).contains(&g)
        && (0..=255).contains(&b)
    {
...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        i16_to_color(tuple.0, tuple.1, tuple.2)
    }
}
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        i16_to_color(arr[0], arr[1], arr[2])
    }
}
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        i16_to_color(slice[0], slice[1], slice[2])
    }
}
